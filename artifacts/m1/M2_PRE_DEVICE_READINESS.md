...
- [ ] Dart formatting and repository diff checks pass.
- [ ] Flutter static analysis passes with the locked dependency set.
- [ ] Focused Legacy oracle tests pass.
- [ ] Full Flutter tests pass.
- [ ] Python oracle-validator tests and bytecode compilation pass.
- [ ] All deterministic fixtures are regenerated with a manifest.
- [ ] A clean-source `devProfile` APK and provenance JSON are retained.
- [ ] WSL, Git mirror, Windows workspace, and GitHub branch resolve to the same
      commit.
...
- The Android toolchain currently builds successfully with command-line tools
  22.0, AGP 8.13.2, Gradle 8.14.5, and compile SDK 36. The SDK XML message is a
  tool-component compatibility warning; no M2 behavior failure was observed.
